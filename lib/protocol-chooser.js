...
const { isLegacySockJS } = require("./sockjs-util");
...
exports.init = function(shinyServer, disableProtocols) {
  ...
  let availableOptions = isLegacySockJS()
    ...
    : ["websocket","xdr-streaming","xhr-streaming","eventsource","iframe-eventsource","htmlfile","iframe-htmlfile","xdr-polling","xhr-polling","iframe-xhr-polling","jsonp-polling"];
